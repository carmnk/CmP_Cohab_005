...
export type QueryFnType<PayloadType = Payload, ResponseType = Response> = (
  url: string,
  payload?: PayloadType,
  queryConfig?: QueryConfigType
) => Promise<AxiosResponse<ResponseType>>

export const post2 = async <PayloadType = Payload, ResponseType = unknown>(
  url: string,
  payload?: PayloadType,
  queryConfig?: QueryConfigType
): Promise<AxiosResponse<ResponseType>> => {
  ...
  return new Promise(function (resolve, reject) {
    const headers: QueryConfigType['headers'] = {
...
export const get2 = async <PayloadType = undefined, ResponseType = Response>(
  url: string,
  payload?: PayloadType,
  queryConfig?: QueryConfigType
): Promise<AxiosResponse<ResponseType>> => {
  const { headers: queryHeaders } = queryConfig ?? {}
...
export const getFile2 = async <PayloadType = undefined, ResponseType = Blob>(
  url: string,
  payload?: PayloadType,
  queryConfig?: QueryConfigType
): Promise<AxiosResponse<ResponseType>> => {
...
export const put2 = async <PayloadType = Payload, ResponseType = Response>(
  url: string,
  payload?: PayloadType,
  queryConfig?: QueryConfigType
): Promise<AxiosResponse<ResponseType>> => {
...
export const deletion2 = async <PayloadType = Payload, ResponseType = Response>(
  url: string,
  payload?: PayloadType,
  queryConfig?: QueryConfigType
): Promise<AxiosResponse<ResponseType>> => {
...
export const redirectToLoginPageIfTokenIsExpired = (
  error: AxiosError<unknown, { data: { msg: string } }>
) => {
  // if (process?.env?.JEST_WORKER_ID !== undefined) return
  //log('REDIRECETED', error)
  if (
    error.response &&
